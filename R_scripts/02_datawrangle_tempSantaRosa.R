...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Santa Rosa/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[6]])#need to correct date from 1/10/1937 to 7/25/12
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2011-07-03 00:00:00', tz="America/Denver"), as.POSIXct('2011-07-11 00:00:00', tz="America/Denver")), date_breaks="1 days") +
...
LJWB_HOBO_hrly_ts_1st <- filter(LJWB_HOBO_hrly_ts, date < as.Date("2011-11-29"))
LJWB_HOBO_hrly_ts_2nd <- filter(LJWB_HOBO_hrly_ts, date>as.Date("2011-12-02"))
LJWB_HOBO_hrly_ts<-rbind(LJWB_HOBO_hrly_ts_1st, LJWB_HOBO_hrly_ts_2nd)
LJWB_HOBO_hrly_ts_3rd <- filter(LJWB_HOBO_hrly_ts, date < as.Date("2011-12-14"))
LJWB_HOBO_hrly_ts_4th <- filter(LJWB_HOBO_hrly_ts, date>as.Date("2011-12-19"))
LJWB_HOBO_hrly_ts<-rbind(LJWB_HOBO_hrly_ts_3rd, LJWB_HOBO_hrly_ts_4th)
LJWB_HOBO_hrly_ts<-LJWB_HOBO_hrly_ts[-c(307),]
...
LJWB_HOBO_hrly_ts_export$siteID = "SantaRosa"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/SantaRosa_temp.csv")
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/SantaRosa_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "SantaRosa"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/SantaRosa_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="SantaRosa2.png", width=6.4, height=5.5, units="in")
