...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Jaramillo Upper Flume/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[20]])#fix year 2037
...
# note that I'm making a new list when I do this so that the original dataframes remain unchanged and I can go back to them if I need to?strptime
...
# Third, I will correct dates in df 20
View(LJWB_HOBO_list_2[[20]])
range(LJWB_HOBO_list_2[[20]]$date)
...
diff_date = as.Date("2037-01-11") - as.Date("2012-07-26")

# apply correction
LJWB_HOBO_list_2[[20]]$date = LJWB_HOBO_list_2[[20]]$date - diff_date
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2011-03-02 17:00:00', tz="America/Denver"), as.POSIXct('2011-03-27 00:00:00', tz="America/Denver")), date_breaks="7 days") + 
...
LJWB_HOBO_hrly_ts_export$siteID = "JaramilloUpper"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/JaramilloUpper_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "JaramilloUpper"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/JaramilloUpper_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "JaramilloUpper"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/JaramilloUpper_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="JaramilloUpper.png", width=6.4, height=5.5, units="in")
