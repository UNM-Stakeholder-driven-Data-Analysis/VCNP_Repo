...
View(LJWB_HOBO_list_2[[1]])
#rename_F_data_col
colnames(LJWB_HOBO_list_2[[1]])[3] <- "Original_F"
# calculate correction
LJWB_HOBO_list_2[[1]]$Temp_C = (LJWB_HOBO_list_2[[1]]$Original_F-32)*(5/9)
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2017-11-10 17:00:00', tz="America/Denver"), as.POSIXct('2018-02-27 00:00:00', tz="America/Denver")), labels = date_format("%m/%d"), date_breaks="7 days") + 
...
LJWB_HOBO_hrly_ts_export$siteID = "Jaramillo Above East Fork Jemez"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/JaramilloabvEastForkJemez_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "Jaramillo Above East Fork Jemez"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/JaramilloabvEastForkJemez_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "Jaramillo Above East Fork Jemez"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/JaramilloabvEastForkJemez_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="JaramilloAboveEastForkJemez.png", width=6.4, height=5.5, units="in")
