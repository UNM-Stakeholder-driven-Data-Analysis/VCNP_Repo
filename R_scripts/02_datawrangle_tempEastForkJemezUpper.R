...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/WFDCG/East Fork Jemez Upper/", 
                            recursive=F, 
                            full.names=TRUE)
...
# apply correction
LJWB_HOBO_list_2[[6]]$date = LJWB_HOBO_list_2[[6]]$date - diff_date
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2013-08-28 00:00:00', tz="America/Denver"), as.POSIXct('2013-09-10 00:00:00', tz="America/Denver")), date_breaks="1 days") +
  scale_y_continuous(limits=c(0,30))

#need to delete data where logger wasn't stopped but appears to be removed from water
LJWB_HOBO_hrly_ts$date <- as.Date(LJWB_HOBO_hrly_ts$datetime_NM)
LJWB_HOBO_hrly_ts_1st <- filter(LJWB_HOBO_hrly_ts, date < as.Date("2013-08-28"))
LJWB_HOBO_hrly_ts_2nd <- filter(LJWB_HOBO_hrly_ts, date>as.Date("2014-04-20"))
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme(legend.title = element_blank()) +
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2013-08-25 17:00:00', tz="America/Denver"), as.POSIXct('2014-01-01 00:00:00', tz="America/Denver")), labels = date_format("%m/%d"), date_breaks="10 days") + 
  scale_y_continuous(limits=c(0,30))

#will filter out data between 12/10 and 3/23
LJWB_HOBO_hrly_ts$date <- as.Date(LJWB_HOBO_hrly_ts$datetime_NM)
...
LJWB_HOBO_hrly_ts<- filter(LJWB_HOBO_hrly_ts, date<"2013-08-29")
...
LJWB_HOBO_hrly_ts_export$siteID = "EastForkJemezUpper"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/EastForkJemezUpper_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "EastForkJemezUpper"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/EastForkJemezUpper_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "EastForkJemezUpper"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/EastForkJemezUpper_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="EastForkJemezUpper.png", width=6.4, height=5.5, units="in")
