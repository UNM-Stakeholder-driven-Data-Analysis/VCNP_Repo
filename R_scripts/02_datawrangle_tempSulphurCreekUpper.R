...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Sulphur Creek Upper/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[4]]) #need to correct date from 1/10/1937 to 7/25/12
...
# View(LJWB_HOBO_list[[22]]) #need to split date and time


# These look like they are structured the same. Except list 1 and 2 need first two columns split
LJWB_HOBO_list[[22]]$Date.Time..GMT.06.00.1 <- format(strptime(LJWB_HOBO_list[[22]]$Date.Time..GMT.06.00, format="%m/%d/%y %I:%M:%S %p"), format="%H:%M:%S")
LJWB_HOBO_list[[22]]$Date.Time..GMT.06.00 <- as.Date(LJWB_HOBO_list[[22]]$Date.Time..GMT.06.00, format="%m/%d/%y")
LJWB_HOBO_list[[22]] <- LJWB_HOBO_list[[22]] %>% relocate(Date.Time..GMT.06.00.1, .after=Date.Time..GMT.06.00)
...
# I will correct dates in df 4
View(LJWB_HOBO_list_2[[4]])
range(LJWB_HOBO_list_2[[4]]$date)
...
# apply correction
LJWB_HOBO_list_2[[4]]$date = LJWB_HOBO_list_2[[4]]$date + diff_date
# check new range
range(LJWB_HOBO_list_2[[4]]$date)
...
LJWB_HOBO_hrly_ts_export$siteID = "SulphurCreekUpper"
#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/SulphurCreekUpper_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "SulphurCreekUpper"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/SulphurCreekUpper_temp_monthly.csv")
...
dat_yearly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            Value.sd = sd(temp_C_c, na.rm = T), 
            Value.n = n())
dat_yearly$siteID = "SulphurCreekUpper"
#export as csv
write.csv(dat_yearly,"C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/SulphurCreekUpper_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="SulphurCreekUpper.png", width=6.4, height=5.5, units="in")
