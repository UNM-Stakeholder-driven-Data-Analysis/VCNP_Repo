...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Redondo Upper CZO flume/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[4]]) # need to change date from 1/16/1937 to 7/31/12
...
LJWB_HOBO_hrly_ts_export$siteID = "RedondoUpperCZOFlume"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/RedondoUpperCZOflume_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "RedondoUpperCZOFlume"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/RedondoUpperCZOflume_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "RedondoUpperCZOFlume"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/RedondoUpperCZOflume_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="RedondoUpperCZOFlume.png", width=6.4, height=5.5, units="in")
