...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Vallecito Creek in Palizo Canyon/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[6]]) #need to correct date from 1/4/1937 to 7/19/12
...
diff_date = as.Date("2012-07-19") - as.Date("1937-01-04")
# apply correction
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2011-08-30 12:00:00', tz="America/Denver"), as.POSIXct('2011-09-30 00:00:00', tz="America/Denver")), date_breaks="2 days") +
...
LJWB_HOBO_hrly_ts_1st <- filter(LJWB_HOBO_hrly_ts, date < as.Date("2012-07-06"))
LJWB_HOBO_hrly_ts_2nd <- filter(LJWB_HOBO_hrly_ts, date>as.Date("2012-07-25"))
...
LJWB_HOBO_hrly_ts_export$siteID = "VallecitoCreekinPalizoCanyon"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/VallecitoCreekinPalizoCanyon_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "VallecitoCreekinPalizoCanyon"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/VallecitoCreekinPalizoCanyon_temp_monthly.csv")
...
dat_yearly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            Value.sd = sd(temp_C_c, na.rm = T), 
            Value.n = n())
dat_yearly$siteID = "VallecitoCreekinPalizoCanyon"
#export as csv
write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/VallecitoCreekinPalizoCanyon_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="VallecitoCreekinPalizoCanyon.png", width=6.4, height=5.5, units="in")
