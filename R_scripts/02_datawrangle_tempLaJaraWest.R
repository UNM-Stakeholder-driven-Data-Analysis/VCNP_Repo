...
# View(LJWB_HOBO_list[[2]]) #date 1/11/37 needs to be fixed
...
# View(LJWB_HOBO_list[[17]]) #need to split left column to date and time
...
View(LJWB_HOBO_list_2[[16]])

#convert_F_to_C
View(LJWB_HOBO_list_2[[15]])
# calculate correction
LJWB_HOBO_list_2[[15]]$Temp_C = (LJWB_HOBO_list_2[[15]]$Temp..Â.F..LGR.S.N..9811671..SEN.S.N..9811671. -32)*(5/9)
#rename_F_data_col
LJWB_HOBO_list_2[[15]]  <- LJWB_HOBO_list_2[[15]] %>% 
  rename(Original_F = Temp..Â.F..LGR.S.N..9811671..SEN.S.N..9811671.)
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2012-10-20 17:00:00', tz="America/Denver"), as.POSIXct('2012-10-25 00:00:00', tz="America/Denver")), date_breaks="30 days") + 
  scale_y_continuous(limits=c(-20,10))

#freezecorrection
tmp <- rle(LJWB_HOBO_hrly_ts$temp_C)
reps <- rep(tmp$lengths > 8,times = tmp$lengths)
...
freeze_times$winter = ifelse(as.Date(freeze_times$date_timeNM)>as.Date("2012-10-01") &
...
LJWB_HOBO_hrly_ts_export$siteID = "LaJaraWest"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/LaJaraWest_temp.csv")
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/LaJaraWest_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "LaJaraWest"
          #export as csv
          write.csv(dat_yearly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/LaJaraWest_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="LaJaraWest.png", width=6.4, height=5.5, units="in")