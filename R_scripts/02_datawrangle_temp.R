...
LJWB_file_list = list.files(path="Temp_for_Brionna/Valles_Flume_CSVs_Corrected/La Jara West/", 
                            recursive=F, 
                            full.names=TRUE)
...
LJWB_HOBO_hrly_ts$doy = lubridate::yday(LJWB_HOBO_hrly_ts$datetime_NM)
# plot 
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=doy, y=temp_C))+
