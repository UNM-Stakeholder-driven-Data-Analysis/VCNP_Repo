...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/San Luis/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[3]]) #need to correct date from 1/10/1937 to 7/25/12
...
# View(LJWB_HOBO_list[[22]]) #need to split date/time col
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2012-01-02 00:00:00', tz="America/Denver"), as.POSIXct('2012-04-26 00:00:00', tz="America/Denver")), date_breaks="14 days") +
...
LJWB_HOBO_hrly_ts_export$siteID = "SanLuis"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/SanLuis_temp.csv")
...
#export as csv
write.csv(dat_monthly,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/SanLuis_temp_monthly.csv")
...
#get yearly averages
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "SanLuis"
          #export as csv
          write.csv(dat_yearly,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/SanLuis_temp_yr.csv")
...
ggsave(path="QAQC plots", filename="SanLuis.png", width=6.4, height=5.5, units="in")
