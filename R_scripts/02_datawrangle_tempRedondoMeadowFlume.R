...
LJWB_file_list = list.files(path="C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/raw data/Valles_Flume_CSVs_Corrected/Redondo Meadow Flume/", 
                            recursive=F, 
                            full.names=TRUE)
...
# View(LJWB_HOBO_list[[1]]) #need to separate date/time col
# View(LJWB_HOBO_list[[2]])  #need to separate date/time col
...
# View(LJWB_HOBO_list[[23]]) #need to change date for 1/16/1937
...
LJWB_HOBO_list[[2]]$Date.Time..GMT.06.00.1 <- format(strptime(LJWB_HOBO_list[[2]]$Date.Time..GMT.06.00, format="%m/%d/%y %I:%M:%S %p"), format="%H:%M:%S")
LJWB_HOBO_list[[2]]$Date.Time..GMT.06.00 <- as.Date(LJWB_HOBO_list[[2]]$Date.Time..GMT.06.00, format="%m/%d/%y")
LJWB_HOBO_list[[2]] <- LJWB_HOBO_list[[1]] %>% relocate(Date.Time..GMT.06.00.1, .after=Date.Time..GMT.06.00)
...
ggplot(data=LJWB_HOBO_hrly_ts, aes(x=datetime_NM, y =temp_C))+
  ...
  theme_bw() +
  scale_x_datetime(limits=c(as.POSIXct('2012-10-02 00:00:00', tz="America/Denver"), as.POSIXct('2013-01-26 00:00:00', tz="America/Denver")), date_breaks="30 days") +
...
LJWB_HOBO_hrly_ts_export$siteID = "RedondoMeadowsFlume"

#export as csv
write.csv(LJWB_HOBO_hrly_ts_export,  "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/alldata/RedondoMeadowFlume_temp.csv")
...
dat_monthly =
  ...
  summarise(Value.mn = mean(temp_C_c, na.rm = T), 
            ...
            Value.n = n())
dat_monthly$siteID = "RedondoMeadowsFlume"
...
#export as csv
write.csv(dat_monthly, "C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/monthly/RedondoMeadowFlume_temp_monthly.csv")
          ...
          dat_yearly =
            ...
            summarise(Value.mn = mean(temp_C_c, na.rm = T), 
                      Value.sd = sd(temp_C_c, na.rm = T), 
                      Value.n = n())
          dat_yearly$siteID = "RedondoMeadowsFlume"
          #export as csv
          write.csv(dat_yearly,"C:/Users/Brionna/OneDrive - University of New Mexico/Classes/EPS545_BIO502/VCNP/VCNP_Repo/processed data/yearly/RedondoMeadowFlume_temp_yr.csv") 
...
ggsave(path="QAQC plots", filename="RedondoMeadowsFlume.png", width=6.4, height=5.5, units="in")
